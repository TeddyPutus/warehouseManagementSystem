...
import putus.teddy.command.parser.InputParser;
...
public class TestInputParser {
    ...
    public void testParseDoubleValidInput() {
        ...
        Double actualValue = new InputParser().parseDouble("Test Field", true);
    ...
    public void testParseDoubleEmptyInputWhenInputNotRequired() {
        ...
        Double actualValue = new InputParser().parseDouble("Test Field", false);
    ...
    public void testParseIntValidInput() {
        ...
        int actualValue = new InputParser().parseInt("Test Field", true);
    ...
    public void testParseIntEmptyInputWhenInputNotRequired() {
        ...
        int expectedValue = -1;
        int actualValue = new InputParser().parseInt("Test Field", false);
    ...
    public void testParseStringValidInput() {
        ...
        String actualValue = new InputParser().parseString("Test Field", true);
    ...
    public void testParseStringEmptyInputWhenInputNotRequired() {
        ...
        String actualValue = new InputParser().parseString("Test Field", false);
